...
function check()
{
    ...
    else if (pat.value === "numbers pattern")
    {
        if (shape.value === "top left")
        {
            ...
            for(let i = 1; i <= row + 1; i++)               // rows
            {                                              
                for(let j = 1; j <= row - i + 1; j++)       // columns 
                {                                        
                    out += j;                           
                }                                       
                out += "\n";                                    // new line
        ...
        else if (shape.value === "top right")
        {
            ...
            for (let k = 1; k <= row; k++)                  // rows
            {                                               
                for (let l = 0; l < k; l++)                     // space
                {                                          
                    out += " ";                          
                }                                           
                for (let m = 1; m <= row - k + 1; m++)      // columns
                {                                         
                    out += m;
                }
                out += "\n";                                    // new line
    ...
    else if (pat.value === "reverse numbers pattern")
    {
        ...
        else if (shape.value === "triangle")
        {
            ...
            sample = row + 3    // helps to maintain the triangle shape
